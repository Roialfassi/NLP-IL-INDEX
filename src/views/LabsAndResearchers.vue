...
export default {
  data() {
    return {
      ...
      tags: ["Lab", "Researcher", "Academia","Bar Ilan University", "The Open University of Israel", "Ben-Gurion University", "University of Haifa","Tel Aviv University",
    "The Technion","The Hebrew University of Jerusalem","Non-Profit", "Industry"],
      selectedTag: 'all'
    }
  },
  computed: {
  ...
  beforeMount(){
    let sites = require("@/assets/LabsAndResearchers.json").map(url => ( {...url, expanded: false}))
    this.items = sites;
 },
  methods: {
    filterItems() {
