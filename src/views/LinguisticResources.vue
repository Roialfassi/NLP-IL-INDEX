...
export default {
  data() {
    return {
      ...
      tags: ['Lexicons', 'Dictionaries & Word Lists', 'Treebanks', 'Embeddings', 'Other Resources'],
      selectedTag: 'all'
    }
  },
  computed: {
  ...
  beforeMount(){
    let sites = require("@/assets/LinguisticResources.json").map(url => ( {...url, expanded: false}))
    this.items = sites;
 },
  methods: {
    filterItems() {
