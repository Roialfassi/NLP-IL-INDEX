...
export default {
  data() {
    return {
      ...
      tags: ['Corpora, Lexicon and Dictionary Generation', 'Morphological Analysis & Disambiguation', 'Word Embeddings', 'Methodology', 'Other NLP Papers'],
      selectedTag: 'all'
    }
  },
  computed: {
  ...
  beforeMount(){
    let sites = require("@/assets/Papers.json").map(url => ( {...url, expanded: false}))
    this.items = sites;
 },
  methods: {
    filterItems() {
